...
// Semilla de "Seguimiento técnico": estado inicial cargado una sola vez desde
...
const TECNICO_SEED = [
  ...
  {c:"Cajas",t:"Curso de Resolución de Conflictos en Línea de Cajas",p:"2018-05-29",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Cajas",t:"Curso de Reconocimiento de Pesos",p:"2019-03-19",po:true,mo:true,ev:false,tx:false,d:"Storyline V1",e:""},
  {c:"Cajas",t:"Curso de Reconocimiento de Dólares",p:"2019-03-20",po:true,mo:true,ev:false,tx:false,d:"Storyline V1",e:""},
  {c:"Cajas",t:"Curso de Reconocimiento de Euros",p:"2019-03-21",po:true,mo:true,ev:false,tx:false,d:"Storyline V1",e:""},
  {c:"Cajas",t:"Medios de Pago",p:"01/012026",po:true,mo:true,ev:false,tx:false,d:"Storyline",e:"OK"},
  {c:"Cajas",t:"Introducción al STS",p:"2026-01-01",po:true,mo:true,ev:false,tx:false,d:"Storyline",e:"OK"},
  {c:"Cajas",t:"Curso Básico de Cajas",p:"2014-07-14",po:true,mo:true,ev:false,tx:false,d:"X",e:"Dado de baja"},
  {c:"Cajas",t:"Curso de Mantenimiento de Terminales",p:"2012-12-06",po:true,mo:true,ev:false,tx:false,d:"X",e:"Dado de baja"},
  {c:"Cajas",t:"Curso Básico de Tarjetas y Documentos",p:"2010-10-19",po:true,mo:true,ev:false,tx:false,d:"X",e:"Reemplazado por Medios de Pago"},
  {c:"Cajas",t:"Curso de Cobro de Transacciones",p:"2015-04-29",po:true,mo:true,ev:false,tx:false,d:"X",e:"Reemplazado por Medios de Pago"},
  {c:"Frescos 1",t:"Instructivo de uso de máquina empaquetadora ULMA",p:"",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Frescos 1",t:"Curso de Introducción al Sector Carniceria",p:"2016-01-08",po:true,mo:true,ev:false,tx:false,d:"HTML",e:"(Se abre en otra ventana el curso)"},
  {c:"Frescos 1",t:"Curso de Desposte de Media Res",p:"2016-09-02",po:true,mo:true,ev:false,tx:false,d:"HTML",e:"(Se abre en otra ventana el curso)"},
  {c:"Frescos 1",t:"Cortes de media res - Cuarto Delantero",p:"2024-03-21",po:true,mo:true,ev:false,tx:false,d:"Storyline",e:"Falta portada audiovisual"},
  {c:"Frescos 1",t:"Cortes de media res - Cuarto Trasero",p:"2024-11-12",po:true,mo:true,ev:false,tx:false,d:"Storyline",e:"Falta portada audiovisual"},
  {c:"Frescos 1",t:"Cortes de media res - Pecho",p:"2024-11-12",po:true,mo:true,ev:false,tx:false,d:"Storyline",e:"Falta portada audiovisual"},
  {c:"Frescos 1",t:"Curso de Frutas y Verduras",p:"2017-03-15",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Frescos 1",t:"Armados de frutas y verduras",p:"2026-01-01",po:true,mo:true,ev:false,tx:false,d:"Storyline",e:"Chequear si cambiar color + icono x verde de Frutas y Verduras // Falta portada audiovisual"},
  {c:"Frescos 2",t:"Curso de Corte de Quesos",p:"2020-03-02",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Frescos 2",t:"Curso de Armado de Picadas",p:"2020-03-03",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Frescos 2",t:"Curso de Exhibición de Productos de Pescadería",p:"2025-04-03",po:true,mo:true,ev:false,tx:false,d:"Storyline V2",e:"Faltan las primeras y últimas diapos del último diseño + Portadas audiovisuales"},
  {c:"Elaborados",t:"Curso de Elaboración de Facturas",p:"2020-03-02",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Seguridad e Higiene",t:"Curso de Uso Seguro del Montacargas",p:"2018-09-11",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Seguridad e Higiene",t:"Capacitaciones de Seguridad e Higiene - 2026",p:"",po:true,mo:true,ev:false,tx:false,d:"Videos",e:"OK"},
  {c:"Seguridad e Higiene",t:"Inducción en Prevención de Riesgos Laborales",p:"",po:true,mo:true,ev:false,tx:false,d:"Storyline",e:"OK"},
  {c:"Seguridad e Higiene",t:"Inducción en Seguridad e Higiene",p:"2018-07-06",po:true,mo:true,ev:false,tx:false,d:"X",e:"Dado de baja"},
  {c:"Salón",t:"Curso de Flujo del Hueco de Salón",p:"2022-02-21",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Salón",t:"Curso de Prioridad de Reposición de Salón",p:"2022-04-18",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Salón",t:"Curso de \"N\" Días de Salón",p:"2022-04-20",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Salón",t:"Curso de Relevamiento de Clases de Salón",p:"2022-06-01",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Salón",t:"Curso de Traspasos de Sucursal a 126 de Salón",p:"2022-11-07",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Mantenimiento",t:"Curso de Detección de Incendios",p:"2013-09-25",po:true,mo:true,ev:false,tx:false,d:"HTML",e:"(Se abre en otra ventana el curso)"},
  {c:"Mantenimiento",t:"Curso Básico de Electricidad",p:"2014-03-26",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Mantenimiento",t:"Curso de Seguridad Eléctrica",p:"2015-04-30",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Mantenimiento",t:"Curso de Circuito de Service",p:"2018-03-12",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Mantenimiento",t:"Curso de Puesta a Punto de ULMA Superchick 3.0",p:"2020-07-27",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Mantenimiento",t:"Control de Vehículos Industriales",p:"2025-04-10",po:true,mo:true,ev:false,tx:false,d:"Storyline V2",e:"Faltan las primeras y últimas diapos del último diseño + Portadas audiovisuales"},
  {c:"Control de Calidad",t:"Inspecciones - Control de Calidad",p:"2012-09-26",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Control de Calidad",t:"Curso de Seguridad Alimentaria",p:"2015-06-08",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Control de Calidad",t:"Curso Manual POES",p:"2017-02-06",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Control de Calidad",t:"Curso de Productos ECONOR",p:"2023-12-05",po:true,mo:true,ev:false,tx:false,d:"Storyline",e:"OK"},
  {c:"Control de Calidad",t:"Curso de Productos VICTORY",p:"2024-08-27",po:true,mo:true,ev:false,tx:false,d:"Storyline V2",e:"Faltan las primeras y últimas diapos del último diseño + Portadas audiovisuales"},
  {c:"Servicio Médico",t:"Curso de Prevención Cardiovascular",p:"2023-10-24",po:true,mo:true,ev:false,tx:false,d:"Claude",e:"(Chequear inicio de curso)"},
  {c:"Coto Digital",t:"Curso Básico de Coto Digital",p:"2020-05-26",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Coto Digital",t:"Curso de Coto Digital Picking",p:"2020-12-29",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Coto Digital",t:"Curso Auxiliares administrativos de Coto Digital - Parte 1",p:"",po:true,mo:true,ev:false,tx:false,d:"Storyline V2",e:"Faltan las primeras y últimas diapos del último diseño"},
  {c:"Coto Digital",t:"Curso Auxiliares administrativos de Coto Digital - Parte 2",p:"",po:true,mo:true,ev:false,tx:false,d:"Storyline V2",e:"Faltan las primeras y últimas diapos del último diseño // No tiene el formato corto"},
  {c:"Coto Digital",t:"Curso de Armadores de Coto Digital",p:"",po:true,mo:true,ev:false,tx:false,d:"Storyline V1",e:""},
  {c:"Coto Digital",t:"Cobradores de Coto Digital",p:"",po:true,mo:true,ev:false,tx:false,d:"Storyline",e:"OK"},
  {c:"Seguridad de la Información",t:"Curso de Seguridad de la Información",p:"2024-03-27",po:true,mo:true,ev:false,tx:false,d:"Rediseñando",e:"Actualmente en proceso de rediseño"},
  {c:"Flota Propia",t:"Curso de Choferes de Flota Propia",p:"2025-01-21",po:true,mo:true,ev:false,tx:false,d:"Storyline V1",e:"Faltan las primeras y últimas diapos del último diseño + Portadas audiovisuales"},
  {c:"No Alimentos",t:"Curso Básico de Ventas",p:"2015-10-16",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"No Alimentos",t:"Curso Básico de Coto Hogar",p:"2013-03-07",po:true,mo:true,ev:false,tx:false,d:"HTML",e:"Dado de baja"},
  {c:"No Alimentos",t:"Curso de Prioridad de Reposición de NOA",p:"2024-07-19",po:true,mo:true,ev:false,tx:false,d:"Storyline V1",e:""},
  {c:"No Alimentos",t:"Relevamiento de clases de NOA",p:"",po:true,mo:true,ev:false,tx:false,d:"Storyline",e:"Corregir algunas pequeñas cositas"},
  {c:"No Alimentos",t:"Curso de Análisis de Archivos de Auditoría Textil/Bazar",p:"2020-01-13",po:true,mo:true,ev:false,tx:false,d:"X",e:"Dado de baja"},
  {c:"No Alimentos",t:"Curso de Carpeta Compartida Textil/Bazar",p:"2020-01-13",po:true,mo:true,ev:false,tx:false,d:"X",e:"Dado de baja"},
  {c:"No Alimentos",t:"Curso de GDM Pedido de Repuestos Textil/Bazar",p:"2020-01-13",po:true,mo:true,ev:false,tx:false,d:"X",e:"Dado de baja"},
  {c:"Administración",t:"Curso de Stock Conceptos Básicos",p:"2015-09-21",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Administración",t:"Curso de Administración de Personal \"Operatorias de Cajas\"",p:"2016-01-25",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Administración",t:"Curso Operativo de Cajas \" Apertura del Sector\"",p:"2016-09-23",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Administración",t:"Curso de Análisis de Mermas",p:"2016-12-30",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Administración",t:"Curso de Balanzas",p:"2019-05-30",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Administración",t:"Curso de Toma de Inventario \"¿Qué es un inventario?\"",p:"2020-02-07",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Administración",t:"Curso de Toma de Inventario \"Tipos de Inventario\"",p:"2020-12-03",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Administración",t:"Introductorio de toma de inventario",p:"",po:true,mo:true,ev:false,tx:false,d:"Storyline V2",e:""},
  {c:"Administración",t:"Toma de inventario - Electro",p:"",po:true,mo:true,ev:false,tx:false,d:"Storyline",e:"Está el revés la diapo de Objetivos/Introducción"},
  {c:"Recursos Humanos",t:"Manual de Administración de Recursos Humanos \"Capítulo 1\"",p:"2023-12-01",po:true,mo:true,ev:false,tx:false,d:"Storyline V1",e:""},
  {c:"Recursos Humanos",t:"Manual de Administración de Recursos Humanos \"Capítulo 2\"",p:"2024-09-11",po:true,mo:true,ev:false,tx:false,d:"Storyline V1",e:""},
  {c:"Recursos Humanos",t:"Guías - Procesos de Administración RRHH",p:"",po:true,mo:false,ev:false,tx:false,d:"Archivo PDF",e:""},
  {c:"Recursos Humanos",t:"Manual de Recursos Humanos - Capítulo 2",p:"2018-02-26",po:true,mo:true,ev:false,tx:false,d:"X",e:"Dado de baja"},
  {c:"Recursos Humanos",t:"Manual de Recursos Humanos - Capítulo 3",p:"2018-02-26",po:true,mo:true,ev:false,tx:false,d:"X",e:"Dado de baja"},
  {c:"Recursos Humanos",t:"Manual de Recursos Humanos - Capítulo 4",p:"2018-02-26",po:true,mo:true,ev:false,tx:false,d:"X",e:"Dado de baja"},
  {c:"Recursos Humanos",t:"Manual de Recursos Humanos - Capítulo 5",p:"2018-02-26",po:true,mo:true,ev:false,tx:false,d:"X",e:"Dado de baja"},
  {c:"Recursos Humanos",t:"Manual de Recursos Humanos - Capítulo 6",p:"2018-02-26",po:true,mo:true,ev:false,tx:false,d:"X",e:"Dado de baja"},
  {c:"Recursos Humanos",t:"Manual de Recursos Humanos - Capítulo 7",p:"2018-02-26",po:true,mo:true,ev:false,tx:false,d:"X",e:"Dado de baja"},
  {c:"Recursos Humanos",t:"Manual de Recursos Humanos - Capítulo 8",p:"2018-02-26",po:true,mo:true,ev:false,tx:false,d:"X",e:"Dado de baja"},
  {c:"Gestión Comercial",t:"Curso Básico Comercial",p:"2014-12-19",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Gestión Comercial",t:"Curso de Estudio de Casos \"Clavos\"",p:"2016-10-27",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Gestión Comercial",t:"Curso de Panel de Control",p:"2018-07-06",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Gestión Comercial",t:"Curso de la Aplicación \"Sucursales 3\"",p:"2019-05-22",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"TCI",t:"Curso del Contrato de la Tarjeta TCI",p:"2025-02-12",po:true,mo:true,ev:false,tx:false,d:"Storyline V2",e:""},
  {c:"TCI",t:"Curso de Aplicativo TCI",p:"",po:true,mo:true,ev:false,tx:false,d:"Storyline V2",e:""},
  {c:"TCI",t:"Prevención de LA/FT/FP",p:"2025-02-12",po:true,mo:true,ev:false,tx:false,d:"Storyline",e:"Falta confeti + Portada audiovisual"},
  {c:"Atención al cliente",t:"Curso de Conociendo al Cliente",p:"2013-10-02",po:true,mo:true,ev:false,tx:false,d:"HTML",e:"OK"},
  {c:"Seguridad",t:"Curso de Puestos de Operaciones en Sucursal",p:"2021-10-21",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Seguridad",t:"Curso de Modalidades de Hurto y Controles",p:"2024-03-01",po:true,mo:true,ev:false,tx:false,d:"Storyline V1",e:""},
  {c:"Seguridad",t:"Curso de Recepciones del Centro de Distribución",p:"2013-10-21",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Seguridad",t:"Curso de Recepción de Proveedores",p:"2016-08-10",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Zona E!",t:"Curso de Anfitriones",p:"2014-07-11",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Zona E!",t:"Patio de Comidas - Cocineros",p:"2014-04-07",po:true,mo:true,ev:false,tx:false,d:"HTML",e:""},
  {c:"Zona E!",t:"Curso de Camareros de Zona Gourmet",p:"2024-01-03",po:true,mo:true,ev:false,tx:false,d:"Storyline V2",e:""},
  {c:"Zona E!",t:"Cumples de Zona",p:"2024-07-11",po:true,mo:true,ev:false,tx:false,d:"Storyline",e:"Portadas de unidades en video"},
  {c:"Zona E!",t:"Curso de Cumpleaños",p:"2014-10-17",po:true,mo:true,ev:false,tx:false,d:"X",e:"Dado de baja"},
  {c:"Pañol",t:"-",p:"",po:false,mo:false,ev:true,tx:true,d:"X",e:"Todavía no hay curso"},
  {c:"Centro de Distribución",t:"Frescos - Clark",p:"2013-03-28",po:false,mo:false,ev:true,tx:true,d:"X",e:"Curso inutilizado"},
  {c:"Centro de Distribución",t:"Frescos - Picking",p:"2013-03-28",po:false,mo:false,ev:true,tx:true,d:"X",e:"Curso inutilizado"},
  {c:"Centro de Distribución",t:"Frescos - Cargador",p:"2013-03-28",po:false,mo:false,ev:true,tx:true,d:"X",e:"Curso inutilizado"},
  {c:"Centro de Distribución",t:"Frescos - Recepción",p:"2013-03-28",po:false,mo:false,ev:true,tx:true,d:"X",e:"Curso inutilizado"},
  {c:"Centro de Distribución",t:"No Alimentos - Picking",p:"2013-03-28",po:false,mo:false,ev:true,tx:true,d:"X",e:"Curso inutilizado"},
  {c:"Centro de Distribución",t:"No Alimentos - Clark",p:"2013-03-28",po:false,mo:false,ev:true,tx:true,d:"X",e:"Curso inutilizado"},
  {c:"Centro de Distribución",t:"No Alimentos - Recepción",p:"2013-03-28",po:false,mo:false,ev:true,tx:true,d:"X",e:"Curso inutilizado"},
  {c:"Centro de Distribución",t:"Secos - Picking",p:"2013-03-28",po:false,mo:false,ev:true,tx:true,d:"X",e:"Curso inutilizado"},
  {c:"Centro de Distribución",t:"Secos - Cargador",p:"2013-03-28",po:false,mo:false,ev:true,tx:true,d:"X",e:"Curso inutilizado"},
  {c:"Centro de Distribución",t:"Secos - Clark",p:"2013-03-28",po:false,mo:false,ev:true,tx:true,d:"X",e:"Curso inutilizado"},
  {c:"Centro de Distribución",t:"Secos - Recepción",p:"2013-03-28",po:false,mo:false,ev:true,tx:true,d:"X",e:"Curso inutilizado"},
];
const TECNICO_DISENO_OPTS = [
  "HTML",
  "Storyline",
  "Storyline V1",
  "Storyline V2",
...
function seedTecnico() {
  return TECNICO_SEED.map((s) => ({
    id: uid(),
    categoria: s.c,
    curso: s.t,
    publicacion: s.p,
...
function avatarHTML(id2, flag) {
  ...
  // Si el ID no matchea a nadie del equipo actual (por ejemplo alguien que ya
  // no está), no lo escondemos: se veía como si nadie estuviera asignado.
  if (!miembro)
    return (
      '<span class="avatar ' +
      (flag ? "sm" : "") +
      '" style="background:var(--line);color:var(--ink-soft)" title="Responsable no encontrado en el equipo actual (' +
      esc(id2) +
      ')">?</span>'
    );
...
const BACKEND = {
    ...
    tabla: "planner",
    fila: "coto",
    // Cada cambio obliga a las demás pantallas a bajar el tablero entero: es
    // el costo de guardar todo en un solo documento. Preguntando cada 12 s en
    // vez de cada 5, una ráfaga de ediciones (alguien completando una ficha)
    // se junta en una sola bajada en lugar de tres. Lo que se paga es que un
    // cambio ajeno tarda hasta 12 s en aparecer en pantalla, que para un
  ...
  Store = (function () {
    ...
    // principal (BACKEND.fila). Seguimiento técnico usa una fila propia
    // (TEC_FILA) para no engordar el documento del tablero — ese sí tiene que
    // entrar siempre bajo el tope de 64 KB del POST urgente al cerrar la
    // pestaña.
    return {
      mode: () => modo,
      async load(fila) {
        ...
        if (useSupabase()) {
          let val2;
          try {
            val2 = await leerDeSupabase(fila);
          } catch (e) {
            throw ((modo = "error"), e);
          }
      ...
      async save(obj, urgente, fila) {
        ...
        if (useSupabase()) {
          ...
          if (urgente) {
            try {
              await escribirEnSupabase(fila, obj, true);
              modo = "supabase";
            } catch (err) {
...
// Mismo esquema de fingerprint/tombstone que las tarjetas del Planner, pero
// para las filas de Seguimiento técnico — son arrays con la misma forma
// (id + updatedAt), así que mergeCards() sirve tal cual para las dos cosas.
let savedFingerprintsTec = new Map();
function stampEditedTecnico() {
  const now = Date.now();
  for (const fila of state.tecnico) {
    const fp = cardFingerprint(fila);
    if (savedFingerprintsTec.get(fila.id) !== fp) {
      ((fila.updatedAt = now), savedFingerprintsTec.set(fila.id, fp));
    }
  }
}
function rememberFingerprintsTec(filas) {
  savedFingerprintsTec = new Map(filas.map((f) => [f.id, cardFingerprint(f)]));
}
function dropTecnico(id) {
  const now = Date.now();
  ((state.tecnico = state.tecnico.filter((f) => f.id !== id)),
...
// mezclarlo acá adentro haría que hasta el guardado urgente de una tarjeta
// del Planner (con tope de 64 KB) tuviera que arrastrar las 108 filas del
// Excel semilla.
function docSnapshotTecnico() {
  return {
...
function saveBackup(doc, forzar) {
  const list = readBackups(),
    now = Date.now();
  // Sin conexión la copia local NO es una copia de resguardo: es el único
  // lugar donde queda el trabajo. Ahí se graba siempre (el espaciado de 15
  // minutos haría perder lo último que se hizo) y se pisa la entrada anterior
  // del mismo modo local, para no desalojar el historial previo al corte.
  if (modoLocal) {
    const entrada = nuevaEntradaBackup(doc, now);
    ((entrada.local = true),
      list.length && list[0].local ? (list[0] = entrada) : list.unshift(entrada),
      writeBackups(list.slice(0, BACKUP_MAX)));
    return;
  }
  if (!forzar && list.length && now - list[0].ts < BACKUP_MIN_GAP) return;
  (list.unshift(nuevaEntradaBackup(doc, now)), writeBackups(list.slice(0, BACKUP_MAX)));
}
function nuevaEntradaBackup(doc, now) {
  return {
    ts: now,
    autor: state.user || "",
    tarjetas: doc.cards.length,
    doc: JSON.stringify(doc),
    // Técnico y Archivos Edu Point viven en filas aparte del backend, así que
    // no venían en la copia local: si el backend se caía, se recuperaba el
    // tablero pero no la grilla ni los archivos. Van acá (son ~70 KB juntos).
    // Las fotos de portada no: son 1,3 MB estáticos y no entran en el
    // localStorage sin desalojar las copias anteriores.
    tecnico: JSON.stringify(docSnapshotTecnico()),
    edu: JSON.stringify(docSnapshotEduArchivo()),
  };
}
async function mergeRemoteIntoState() {
  stampEditedCards();
  // Antes de bajar el tablero entero se pregunta el sello, que son 36 bytes:
  // si nadie escribió desde la última vez que lo leímos, no hay nada que
  // mezclar. Importa porque guardar pasa muchas veces seguidas —cada campo que
  // alguien completa dispara uno— y cada guardado bajaba el documento completo
  // aunque el resto del equipo no hubiera tocado nada.
  const sello = await Store.rev();
  if (sello && sello === revConocida) return [];
...
function persist() {
  ...
  // Cada campo que alguien completa dispara un persist(). Con 250 ms, llenar
  // una ficha de seis campos eran seis guardados, y cada uno le costaba una
  // bajada del tablero a cada pantalla abierta. Esperando algo más, esa misma
  // ficha se guarda de una sola vez. El guardado urgente al cerrar la pestaña
  // no pasa por acá, así que no se pierde nada por esperar.
  (clearTimeout(saveTimer), (saveTimer = setTimeout(() => guardarAhora(false), 900)));
}
...
// subir todo. Es explícito a propósito: nadie entra acá sin querer.
let modoLocal = false;
...
async function guardarAhora(urgente) {
  ...
  if (modoLocal) {
    // Sin conexión: la copia local YA quedó guardada arriba, que es todo lo
    // que se puede hacer. No se marca error, porque no lo hay: es el modo que
    // la persona eligió.
    ((guardadoPendiente = false), (state.saveError = false), (state.lastSyncTs = Date.now()));
    (updateSavestate(), showBanner());
        ...
        (state.savedViews || [])
          .map(
            (arg) =>
              ...
              esc(arg.name) +
              '<span class="vx" data-action="view:rename" data-id="' +
              arg.id +
              '" title="Renombrar vista">✏</span><span class="vx" data-action="view:del" data-id="' +
              arg.id +
...
function cardKanban(tarjeta) {
  ...
  return (
    ...
    (state.userId && tarjeta.responsable !== state.userId && !(tarjeta.asignados || []).includes(state.userId)
      ? '<button class="kq-btn" data-action="kcard:assignme" data-id="' + tarjeta.id + '" title="Asignarme">🙋</button>'
      : "") +
...
function eduPointsEnPlanner() {
  return boardCards().filter((tarjeta) => tarjeta.tipo === "edu-point");
}
...
function mapaSectorMap() {
  const conteo = {};
  let sinSector = 0;
  // Cuenta lo publicado, el mismo universo que "Todo lo publicado": antes
  // sumaba también lo que seguía en el Planner, así que el chip decía "Cajas 11"
  // y al tocarlo aparecían 7. El número tiene que ser el que después se ve.
  state.cards
    .filter(inInventory)
    .forEach((tarjeta) => {
  ...
  const filtroActivo = state.filters.sector,
    nombreFiltro = filtroActivo === "__sin_sector__" ? "Sin sector" : sectorName(filtroActivo) || filtroActivo;
  const segmento = (arg) => {
    const sec = arg[0],
      n = arg[1],
  ...
  // Colapsable, y abierta sola cuando hay un sector filtrado: es una métrica
  // ("dónde está concentrado el contenido"), no un filtro de todos los días, y
  // desplegada permanentemente era la mitad de lo que cargaba la vista.
  return (
    '<details class="mapa-sectormap acc" ' +
    (filtroActivo ? "open" : "") +
    '>\n      <summary class="mapa-sectormap-t" style="display:flex;align-items:center;gap:8px">Distribución por sector' +
    (filtroActivo
      ? ' <span style="text-transform:none;letter-spacing:0;font-weight:600;color:var(--ink-soft)">· filtrando ' +
        esc(nombreFiltro) +
        '</span><button class="btn btn-ghost btn-sm" data-action="mapa:sector-clear" style="margin-left:auto;padding:2px 9px;font-size:11px">✕ Quitar filtro</button>'
      : "") +
...
function renderMapa() {
  ...
  // "Todos (164)", como si fueran dos números distintos.
  //
  // Y todos los números pasan por mapaFilter, así que cuando hay un sector
  // activo cuentan lo que realmente se ve abajo y no el total del área.
  const cuenta = (lista) => mapaFilter(lista).length,
    porTipo = (tipo) => cuenta(state.cards.filter((t) => t.tipo === tipo && inInventory(t))),
    lista = [
      {
        id: "todos",
    ...
    html =
      ...
      lista
        .map(
          (arg) =>
            '<div class="mapa-sec ' +
            // "cursos" (solo tipo=curso) ya no tiene chip propio — lo usan 2
            // accesos internos (KPI "Cursos activos" y el reset de datos de
            // prueba) que quieren un subconjunto exacto de "todos", no la
            // unión completa. Si aterrizás ahí, se resalta "todos" en vez de
            // dejar la fila sin ninguna pestaña marcada.
            (state.mapaSec === arg.id || (arg.id === "todos" && state.mapaSec === "cursos") ? "active" : "") +
...
// ===== Seguimiento técnico =====
// Grilla editable que reemplaza al Excel de Categorías y Cursos: cada fila
// vive en state.tecnico (mismo esquema de sync que las tarjetas del
// Planner, ver mergeCards/stampEditedTecnico). Los checkboxes/selects
// escriben directo sobre el estado y no vuelven a dibujar la fila entera —
// así nadie pierde el foco a mitad de una edición.
...
function tecModoGuardar() {
  try {
    localStorage.setItem(TEC_MODO_KEY, tecModo());
  } catch (e) {}
}
...
// Una fecha que no es una fecha (el Excel traía alguna mal tipeada, tipo
// "01/012026") se marca en la grilla en vez de disimularse: es un dato que
// solo el equipo puede corregir, y ahora tiene dónde hacerlo.
function tecFechaMala(iso) {
  const v = (iso || "").trim();
  return !!v && !/^\d{4}-\d{2}-\d{2}$/.test(v);
}
function tecFechaISO(txt) {
  txt = (txt || "").trim();
  if (!txt) return "";
  const m = /^(\d{1,2})\/(\d{1,2})\/(\d{4})$/.exec(txt);
  if (m) return m[3] + "-" + String(m[2]).padStart(2, "0") + "-" + String(m[1]).padStart(2, "0");
  // Se acepta ISO tal cual para no romper lo que ya estaba cargado ni pelearle
...
function tecRows(salvo) {
  ...
  if (state.tecOrden) {
    const campo = state.tecOrden,
      dir = state.tecOrdenDir;
    // slice() antes de ordenar: state.tecnico es el dato real y ordenarlo en
    ...
    lista = lista.slice().sort((a, b) => {
      const va = clave(a),
        vb = clave(b);
      // Lo vacío siempre al final, ordene como ordene: si no, "sin fecha"
      // se apropia de la primera pantalla y tapa lo que se está buscando.
      if (!va && vb) return 1;
      if (va && !vb) return -1;
      if (va === vb) return 0;
...
// Con un orden activo la tabla se aplana y la categoría pasa a ser una columna:
// agrupar y ordenar a la vez daría un orden que solo vale dentro de cada
// bloque, que es justo lo que no sirve para preguntar "cuál es el más viejo".
function tecPlano() {
  return !!state.tecOrden;
}
function tecGroups() {
  const filas = tecRows();
  if (tecPlano()) return filas.length ? [{ categoria: null, filas }] : [];
  const orden = [],
    grupos = {};
  filas.forEach((fila) => {
    const key = fila.categoria || "Sin categoría";
    if (!grupos[key]) {
      grupos[key] = [];
      orden.push(key);
    }
...
function tecDisenoSelect(fila) {
  ...
  return (
    '<select data-tec-id="' +
    fila.id +
    '" data-tec-field="diseno">' +
    (fila.diseno ? "" : '<option value="">—</option>') +
    opts
      .map(
        (o) => '<option value="' + esc(o) + '"' + (fila.diseno === o ? " selected" : "") + ">" + esc(o) + "</option>",
      )
      .join("") +
    "</select>"
  );
}
function tecLinkHTML(fila) {
  const card = fila.cardId ? state.cards.find((c) => c.id === fila.cardId) : null;
  if (card) {
    const titulo = card.titulo.length > 26 ? card.titulo.slice(0, 26) + "…" : card.titulo;
    return (
      '<div class="tec-link-wrap"><button class="tec-link on" data-action="card:open" data-id="' +
      card.id +
      '" title="Abrir en el Mapa/Planner">📍 ' +
      esc(titulo) +
      '</button><span class="chk-del" data-action="tec:unlink" data-id="' +
      fila.id +
      '" title="Quitar vínculo">✕</span></div>'
    );
  }
  return (
    '<button class="tec-link" data-action="tec:link" data-id="' +
    fila.id +
...
function tecNuevaFilaModalHTML(catPrefill) {
  return (
    '<h2>+ Agregar curso a Técnico</h2><div class="sub-t">Crea una fila nueva en Seguimiento técnico.</div>' +
    '<div class="fld"><label>Categoría</label><input id="tecNuevaCat" list="tecCategoriasList" value="' +
    esc(catPrefill || "") +
...
// ===== Técnico en fichas =====
// La grilla se armó como un reemplazo del Excel y se quedó siendo un Excel:
// doce columnas, scroll horizontal, todo del mismo gris y del mismo tamaño.
// Funciona para tipear rápido y no funciona para lo que el área hace de
// verdad, que es mirar un curso y saber cómo viene.
//
// Cada curso pasa a ser una ficha de tres renglones, que entra siempre en el
// ancho de la pantalla:
//
//   ●●●○  Nombre del curso                    [Vigente ▾]  📍 Mapa   ✕
//         ✓ Portada  ✓ Mosaico  ○ Evaluación  ○ Textos  ·  HTML ▾
//         Publicado 04/09/18 ── SCORM — ── Mail —        💬 comentario
//
// Todo se edita ahí mismo: son los mismos campos de la grilla, con los mismos
// data-tec-id, así que guardan por el mismo camino de siempre. La planilla no
// se va a ningún lado —para cargar veinte fechas seguidas sigue siendo más
// rápida—, queda a un clic en la barra de arriba.
const TEC_MODO_KEY = "cf.tecModo.v1";
function tecModo() {
  if (!state.tecModo) {
    let guardado = "";
    try {
...
function tecModoHTML() {
  const m = tecModo();
  return (
    '<div class="tec-modo"><button class="tec-modo-b' +
    (m === "fichas" ? " on" : "") +
    '" data-action="tec:modo" data-m="fichas" title="Cada curso en una ficha, todo a la vista">🗂 Fichas</button><button class="tec-modo-b' +
    (m === "planilla" ? " on" : "") +
    '" data-action="tec:modo" data-m="planilla" title="La tabla de siempre, para cargar muchos datos seguidos">▦ Planilla</button></div>'
  );
}
// Los cuatro tildes de producción, con el nombre al lado. En la planilla son
// cuatro columnas con el encabezado a dos metros del tilde; acá cada uno dice
// qué es, y el que ya está se apaga para que la vista caiga en lo que falta.
function tecFichaPiezasHTML(fila) {
  return (
    '<div class="tf-piezas">' +
    TEC_CHKS.map(
      (k) =>
...
// Las tres fechas como los tres pasos que son, con el campo para editarlas
// debajo de cada una. Es la misma lectura que la vista "Qué falta", pero acá
// además se cargan.
function tecFichaFechasHTML(fila) {
  return (
    '<div class="tf-fechas">' +
    TEC_FECHAS.map((k, i) => {
      const v = (fila[k] || "").trim(),
        mala = v && tecFechaMala(v);
      return (
        (i ? '<i class="tf-arco' + (v && !mala ? " on" : "") + '"></i>' : "") +
        '<span class="tf-paso ' +
        (mala ? "mala" : v ? "ok" : "falta") +
        '"><span class="tf-paso-lbl">' +
        esc(tecColLabel(k)) +
        (mala ? ' <b title="No se entiende como fecha">⚠</b>' : "") +
        '</span><input type="date" class="tec-date' +
        (v && !mala ? "" : " vacia") +
        '" data-tec-id="' +
        fila.id +
        '" data-tec-field="' +
...
function tecFichaHTML(fila) {
  const viva = tecFilaActiva(fila),
    p = tecPiezas(fila);
  return (
    '<article class="tf' +
    (viva ? "" : " baja") +
    (p.total && p.hechas === p.total ? " full" : "") +
    '" data-tec-row="' +
    fila.id +
    '"><div class="tf-h">' +
    tecSemaforoHTML(fila) +
    '<input class="tf-nombre" type="text" data-tec-id="' +
    fila.id +
    '" data-tec-field="curso" value="' +
    esc(fila.curso) +
    '" placeholder="Nombre del curso">' +
    (tecPlano()
      ? '<input class="tf-cat" type="text" list="tecCategoriasList" data-tec-id="' +
        fila.id +
        '" data-tec-field="categoria" value="' +
        esc(fila.categoria) +
    ...
    '<span class="tf-mapa">' +
    tecLinkHTML(fila) +
    '</span><span class="chk-del" data-action="tec:del" data-id="' +
    fila.id +
    '" title="Borrar esta fila">✕</span></div>' +
    // Dos renglones y no tres: con ciento catorce cursos, cada renglón de más
    // son mil píxeles de scroll. El comentario va en la misma línea que las
    // piezas —tiene todo el espacio sobrante— en vez de ocupar uno propio que
    // la mayor parte del tiempo está vacío.
    '<div class="tf-cuerpo">' +
    tecFichaPiezasHTML(fila) +
    '<span class="tf-diseno">' +
    tecDisenoSelect(fila) +
    '</span><input class="tf-com" type="text" data-tec-id="' +
    fila.id +
    '" data-tec-field="estado" value="' +
    esc(fila.estado || "") +
    '" placeholder="Comentario…">' +
    tecFichaFechasHTML(fila) +
    "</div></article>"
  );
}
function tecFichasHTML() {
  const grupos = tecGroups();
  if (!grupos.length)
    return (
      tecCategoriasDatalistHTML() +
      '<div class="empty"><div class="big">🔍</div><div style="font-weight:700;color:var(--ink)">Sin resultados</div><div style="margin-top:4px">Probá con otra búsqueda o quitá los filtros de arriba.</div></div>'
    );
  return (
    tecCategoriasDatalistHTML() +
    grupos
      .map(
        (g) =>
          '<section class="tf-grupo">' +
          (g.categoria === null
            ? ""
            : '<div class="tf-grupo-h"><h3>' +
              esc(g.categoria) +
              '</h3><span class="tf-grupo-n">' +
              g.filas.length +
              " curso" +
              (g.filas.length === 1 ? "" : "s") +
              "</span>" +
              tecCatAvanceHTML(g.filas) +
              '<button class="btn btn-ghost btn-sm" data-action="tec:add" data-cat="' +
              esc(g.categoria) +
              '">+ Agregar acá</button></div>') +
          g.filas.map(tecFichaHTML).join("") +
          "</section>",
      )
      .join("")
  );
}
// Tildar una pieza cambia el semáforo del encabezado de la ficha y el avance
// de la categoría. Se tocan a mano en vez de redibujar todo: redibujar con el
// foco puesto en un campo de texto lo tira, y acá se trabaja escribiendo.
function tecFichaSync(filaId) {
  const fila = state.tecnico.find((f) => f.id === filaId),
    ficha = document.querySelector('.tf[data-tec-row="' + filaId + '"]');
  if (!fila || !ficha) return;
  const sem = ficha.querySelector(".tec-sem"),
    p = tecPiezas(fila);
  if (sem) sem.outerHTML = tecSemaforoHTML(fila);
  ficha.classList.toggle("full", !!p.total && p.hechas === p.total);
  TEC_CHKS.forEach((k) => {
    const lbl = ficha.querySelector('[data-tec-field="' + k + '"]');
    if (lbl && lbl.parentElement) lbl.parentElement.classList.toggle("on", !!fila[k]);
  });
  const grupo = ficha.closest(".tf-grupo"),
    av = grupo && grupo.querySelector(".tec-cat-av");
  if (av) {
    const filas = Array.from(grupo.querySelectorAll(".tf")).map((el) =>
      state.tecnico.find((f) => f.id === el.dataset.tecRow),
    );
    av.outerHTML = tecCatAvanceHTML(filas.filter(Boolean));
  }
}
...
function renderTecList() {
  ...
  const falta = state.tecSubView === "falta",
    planilla = !falta && tecModo() === "planilla";
  ((el.innerHTML = falta ? tecFaltaHTML() : planilla ? tecListHTML() : tecFichasHTML()),
    tecTopSync(),
    planilla && tecGrillaAlto());
}
...
// viene a esta vista—. Ahora es una sola barra: los mismos cuatro números,
// los mismos cuatro filtros, en un quinto del alto.
function tecKpi(n, label, color, cual) {
  return (
    '<button class="tec-stat tono-' +
    color +
    (state.tecPendiente === cual ? " on" : "") +
    '" data-action="tec:kpi" data-cual="' +
    cual +
    '" title="' +
    (cual ? "Ver solo estos" : "Ver todos") +
    '"><b>' +
    n +
    "</b><span>" +
    esc(label) +
...
// equivalente en Técnico ya que "categoría" es lo más parecido a un sector
// que tiene la grilla.
function tecCategoriaFiltroHTML() {
  const conteo = {};
  ...
  if (!claves.length) return "";
  return (
    '<div class="filt">🏷<select id="tecCategoria"><option value="">Categoría: todas (' +
...
// entera y el cursor se saldría del buscador a mitad de palabra.
function tecTopSync() {
  const elN = $("#tecTopN"),
    elL = $("#tecLimpiar");
  ...
  return (
    ...
    (sub === "matri"
      ...
      : sub === "revision"
        ...
        (sub === "grilla" ? tecModoHTML() : "") +
        (sub === "grilla" && tecModo() === "planilla" ? tecColsPopHTML() : "") +
        ...
        tecKpisHTML() +
        (sub === "grilla" && tecModo() === "planilla" ? tecVistasHTML() : "") +
        '<div id="tecList">' +
        (sub === "falta" ? tecFaltaHTML() : tecModo() === "planilla" ? tecListHTML() : tecFichasHTML()) +
        "</div>")
  );
}
...
function tecPickListHTML(cursos, filtro) {
  ...
  return lista
    .map(
      (c) =>
        '<div class="tec-pick-row" data-action="tec:linkpick" data-id="' +
        c.id +
        '"><span style="flex:1">' +
        esc(c.titulo) +
        "</span>" +
        (inInventory(c) ? '<span class="badge" style="margin-left:8px">Mapa</span>' : "") +
        "</div>",
    )
    .join("");
}
...
// La contraparte de tecFilaParaCard(): dada una fila, la tarjeta que le
// corresponde (por vínculo o, si no hay, por título igual).
function tecCardDeFila(fila) {
  return fila.cardId
...
// edita después de vincular.
function valTitulosDifieren() {
...
//
// La línea punteada del promedio: con un mes que se lleva 78 de 79, todas las
// demás barras quedan pegadas al piso y el gráfico no dice nada más que "hubo
// un pico". La referencia te deja leer cada mes contra lo normal del año, que
// es la pregunta real.
function repBarsHTML(bars, vacioMsg, compacto) {
  const max = Math.max(1, ...bars.map((b) => b.n)),
    total = bars.reduce((a, b) => a + b.n, 0),
    prom = total / (bars.length || 1),
    // Solo cuando hay de dónde promediar y la línea no se confunde con el
    // piso ni con el techo del gráfico.
    // Con el promedio pegado al piso o al techo la línea no dice nada: es el
    // eje o es la barra más alta. Solo aparece cuando cae en el medio.
    verProm = total > 0 && bars.length > 2 && prom / max > 0.14 && prom / max < 0.9;
  return (
    '<div class="rep-chart' +
    (compacto ? " compacto" : "") +
    '">' +
    // La referencia va en su propia capa, del alto exacto de las barras: el
    // gráfico también reserva lugar arriba para el número y abajo para el mes,
    // así que medirla contra el alto total la dejaría fuera de lugar.
    (verProm
      ? '<div class="rep-prom-capa"><span class="rep-prom" style="bottom:' +
        Math.round((prom / max) * 1000) / 10 +
        '%" data-prom="prom. ' +
        Math.round(prom * 10) / 10 +
        '"></span></div>'
      : "") +
    bars
      .map((b) => {
...
// las demás.
// El catálogo por sector, como una sola barra partida en colores más su
// referencia debajo. Antes eran veinte filas de nombre + barrita + número en
// dos columnas: se leía cada sector por separado pero no se veía la mezcla,
// que es justamente lo que se va a mirar en una reunión de fin de año ("de
// qué está hecho el catálogo"). Es el mismo lenguaje que la distribución por
// sector del Mapa.
function repSectoresHTML() {
  const conteo = {};
  repCursosActivos().forEach((c) => {
    (c.sectores || []).forEach((sec) => (conteo[sec] = (conteo[sec] || 0) + 1));
  ...
  const total = entradas.reduce((acc, e) => acc + e[1], 0),
    nombre = (sec) => (sec ? sectorName(sec) || sec : "Sin sector"),
    color = (sec) => (sec && SECTORES[sec] ? SECTORES[sec].cat : "var(--coto-chambray)"),
    pct = (n) => Math.round((n / total) * 1000) / 10;
  return (
    '<div class="rep-mix"><div class="rep-mix-bar">' +
    entradas
      .map(
        (e) =>
    ...
    entradas
      .map(
        (e) =>
          '<button class="rep-mix-i" data-action="rep:sector" data-sector="' +
          esc(e[0]) +
          '" title="Ver los cursos de ' +
          esc(nombre(e[0])) +
          '"><i style="background:' +
          color(e[0]) +
          '"></i><span>' +
...
function repRevisionHTML() {
  ...
  return (
    ...
    // Un "0" en 34 px cuando lo que pasa es que no hay ninguna fecha cargada
    // es un número inventado con cuerpo de titular: sin datos, va el texto.
    (dias.length
      ? '<div class="rep-espera-p"><b>' +
        prom +
        "</b><span>día" +
        (prom === 1 ? "" : "s") +
        " esperando, en promedio<i>Sobre " +
        dias.length +
        " con fecha de entrada" +
        (sinSello ? " · " + sinSello + " sin fecha" : "") +
        "</i></span></div>"
      : "") +
    (peores.length
      ? '<div class="rep-espera-lista">' +
        peores
          .map((p) => {
            // La barra dice cuánto espera ésta respecto de la que más espera,
            // y el tono sube de neutro a rojo pasando el mes: un "45 días"
            // suelto no dice si es mucho hasta que lo comparás con el resto.
            const grave = p.d >= 30 ? "mal" : p.d >= 14 ? "medio" : "";
            return (
              '<div class="rep-espera-f" data-action="card:open" data-id="' +
              p.c.id +
              '"><span class="rep-espera-t">' +
              esc(p.c.titulo) +
              '</span><span class="rep-espera-b"><i style="width:' +
              Math.round((p.d / Math.max(1, peores[0].d)) * 100) +
              '%"></i></span><span class="rep-espera-d ' +
              grave +
              '">' +
              p.d +
              " d</span>" +
              (p.c.responsable ? avatarHTML(p.c.responsable, true) : '<span class="rep-espera-nadie">?</span>') +
              "</div>"
            );
          })
          .join("") +
...
function sectionEduPoints() {
  const colocados = mapaFilter(
      state.cards.filter((tarjeta) => tarjeta.tipo === "edu-point" && inInventory(tarjeta)),
    ),
    enPlanner = mapaFilter(eduPointsEnPlanner());
  if (!colocados.length && !enPlanner.length)
    return emptyState(
      "📍",
      "Todavía no hay Edu Points",
      "Creá un Edu Point en el Planner y va a aparecer acá mientras se arma; cuando lo marques como colocado pasa al inventario.",
    );
  // Los que están en el tablero van en su propio bloque y no mezclados con los
  // colocados: son dos cosas distintas y confundirlas es lo que hacía que el
  // número de arriba no significara nada.
  const bloque = (titulo, sub, filas, tarjeta) =>
    filas.length
      ? '<div class="mapa-bloque"><div class="mapa-bloque-t">' +
        titulo +
        ' <span class="mapa-bloque-n">' +
        filas.length +
        '</span></div><div class="mapa-bloque-d">' +
        sub +
        '</div><div class="cursos-grid">' +
...
function inicioProxHTML() {
  ...
  if (!lista.length) return "";
  return (
    '<section class="ini-card ini-card-prox"><div class="ini-card-h"><h2>Lo que viene</h2>' +
    ...
    lista
      .map((tarjeta) => {
        const faltan = daysBetween(todayISO(), tarjeta.fin || tarjeta.inicio);
        return (
          '<div class="ini-prox" data-action="card:open" data-id="' +
          tarjeta.id +
          ...
          esc(tarjeta.titulo) +
          "</span>" +
          // La inicial de quien la tiene, en su color: se reconoce de un
          // vistazo, ocupa un cuarto de lo que ocupaba el nombre escrito, y
          // es el mismo avatar que usa el resto de la app.
          (tarjeta.responsable ? avatarHTML(tarjeta.responsable, true) : '<span class="ini-prox-nadie">—</span>') +
          "</div>"
        );
      })
      .join("") +
...
// El pulso: cuántas tareas hay en cada estado. Cada uno lleva al Planner ya
// filtrado por ese estado.
//
...
//
// Empezó como cuatro números sueltos en una línea de texto. Se leían, pero al
// lado de las ocho tarjetas de arriba parecían el pie de página de otra app.
// Ahora es una tarjeta más, con la barra de cada estado proporcional a la más
// alta: además del número se ve la forma del tablero.
const INI_PULSO = {
  pendiente: "Pendientes",
  "en-desarrollo": "En desarrollo",
  "en-revision": "En revisión",
  finalizado: "Terminadas",
};
function inicioPulsoHTML() {
  const lista = boardCards(),
    cuenta = ESTADOS.map((estado) => lista.filter((tarjeta) => tarjeta.estado === estado.id).length),
  ...
  return (
    ...
    ESTADOS.map(
      (estado, i) =>
        ...
        '" style="--tono:' +
        estado.dot +
        '"><span class="ini-pulso-n">' +
        esc(INI_PULSO[estado.id] || estado.nombre) +
        '</span><span class="ini-pulso-b"><i style="width:' +
        Math.round((cuenta[i] / max) * 100) +
        '%"></i></span><span class="ini-pulso-c">' +
        cuenta[i] +
        "</span></button>",
    ).join("") +
    "</div></section>"
...
function inicioPieHTML() {
  const prox = inicioProxHTML();
  return '<div class="ini-pie' + (prox ? "" : " solo") + '">' + prox + inicioPulsoHTML() + "</div>";
}
  ...
  const val2 = Math.max(1, ...TEAM.map((miembro) => obj[miembro.id].n)),
    txt = TEAM.map((miembro) => {
      ...
      return (
        ...
        miembro.id +
        '" style="cursor:pointer" title="Ver las tarjetas de ' +
        esc(miembro.nombre) +
        ' en el Planner">' +
...
// Seguimiento técnico se guarda y sincroniza aparte, con su propio debounce
// y su propia fila (TEC_FILA) — deliberadamente NO comparte el camino de
// touch()/persist() de las tarjetas del Planner. Ese camino es el que hace
// el guardado urgente al cerrar la pestaña bajo el tope de 64 KB del POST
// keepalive, y encadenarle acá un ida y vuelta extra por cada guardado de
// tarjeta terminaba retrasando justo esa ruta.
let tecSaveTimer = null;
function touchTecnico() {
  (stampEditedTecnico(), clearTimeout(tecSaveTimer), (tecSaveTimer = setTimeout(guardarTecnicoAhora, 250)));
}
async function guardarTecnicoAhora() {
  if (useSupabase()) {
    try {
      const remote = await Store.remote(TEC_FILA);
      if (remote && Array.isArray(remote.tecnico)) {
        const merged = mergeCards(state.tecnico, remote.tecnico, state.deletedTecnico, remote.deletedTecnico || {});
        ((state.tecnico = merged.cards), (state.deletedTecnico = merged.deleted));
      }
    } catch (e) {}
  }
  try {
    (await Store.save(docSnapshotTecnico(), false, TEC_FILA), rememberFingerprintsTec(state.tecnico));
  } catch (err) {
    console.error("No se pudo guardar Seguimiento técnico:", err);
  }
}
// Al entrar a la vista, trae lo que haya cambiado del lado del servidor
// (por si alguien más editó mientras no estabas ahí) — sin tocar el poll de
// las tarjetas.
async function refreshTecnicoFromRemote() {
  ...
  try {
    ...
    if (remote && Array.isArray(remote.tecnico)) {
      const merged = mergeCards(state.tecnico, remote.tecnico, state.deletedTecnico, remote.deletedTecnico || {});
      ((state.tecnico = merged.cards), (state.deletedTecnico = merged.deleted));
      if (state.view === "tecnico") renderTecList();
    }
  } catch (e) {}
}
...
document.addEventListener("click", (ev) => {
  ...
  switch (val9) {
    ...
    case "reintentar:conexion":
      location.reload();
      break;
    // Bajarse la copia local desde la pantalla de error: si el backend está
    // caído no hay forma de entrar a Ajustes, y es justo cuando más falta hace
    // tener los datos en la mano.
    case "local:bajar": {
      const copia = readBackups()[0];
      if (!copia) {
        flash("No hay ninguna copia local en este navegador", true);
        break;
      }
      let docCopia = {};
      try {
        docCopia = JSON.parse(copia.doc);
      } catch (e) {}
      (download(
        "cotonetes-copia-local.json",
        JSON.stringify(
          {
            version: 1,
            exportado: new Date().toISOString(),
            copiaDel: new Date(copia.ts).toISOString(),
            cards: docCopia.cards || [],
            templates: docCopia.templates || {},
            sectores: docCopia.sectores || {},
            team: docCopia.team || [],
            deleted: docCopia.deleted || {},
            tecnico: copia.tecnico ? JSON.parse(copia.tecnico).tecnico : [],
            eduArchivo: copia.edu ? JSON.parse(copia.edu).eduArchivo : [],
          },
          null,
          2,
        ),
    ...
    case "local:trabajar": {
      const copia2 = readBackups()[0];
      if (!copia2) {
        flash("No hay ninguna copia local en este navegador", true);
        break;
      }
      confirmar(
        "Vas a trabajar con la copia del " +
          fmtBackupDate(copia2.ts) +
          ", guardando solo en esta computadora. El equipo no ve estos cambios hasta que los subas. ¿Seguir?",
        () => entrarModoLocal(copia2),
      );
      break;
    }
    case "local:subir":
    ...
    case "tec:modo":
      ((state.tecModo = el.dataset.m === "planilla" ? "planilla" : "fichas"), tecModoGuardar(), render());
      break;
    case "tec:vista": {
    ...
    case "notif:markread":
      ...
      break;
    case "notif:solomias":
      ((state.alertasMias = !state.alertasMias), openNotif());
      break;
    case "help:open":
      openHelp();
      break;
    ...
    case "carga:go":
      ...
      break;
    case "tec:del":
      confirmar("¿Borrar esta fila del seguimiento técnico?", () => {
        (dropTecnico(val10), touchTecnico(), renderTecList());
      });
      break;
    case "tec:add":
      // Desde la fila de un grupo ya viene la categoría precargada (pero
      // editable); desde el botón de arriba arranca vacía.
      openModal(tecNuevaFilaModalHTML(el.dataset.cat || ""));
      setTimeout(() => $("#tecNuevoNombre") && $("#tecNuevoNombre").focus(), 50);
      break;
    case "tec:add-confirmar": {
      const nombreTec = ($("#tecNuevoNombre").value || "").trim();
      if (!nombreTec) {
    ...
    case "tec:limpiar":
      ...
      break;
    case "tec:link":
      openModal(tecPickerHTML(val10));
      break;
    case "tec:unlink": {
      const filaTec = state.tecnico.find((f) => f.id === val10);
      if (filaTec) ((filaTec.cardId = null), touchTecnico(), renderTecList());
      break;
    }
    case "tec:linkpick": {
      const elPickList = $("#tecPickList"),
    ...
    case "tec:goto": {
      ...
      if (filaTec3) {
        ((state.tecFiltro = filaTec3.curso), (state.tecSubView = "grilla"), (state.view = "tecnico"), closePanel(), pushNav(), render());
        setTimeout(() => {
    ...
    case "tec:usarnombremapa": {
      const filaNm = state.tecnico.find((f) => f.id === el.dataset.fila);
      if (filaNm) {
        const cardNm = state.cards.find((c) => c.id === el.dataset.card);
        cardNm && ((filaNm.curso = cardNm.titulo), touchTecnico(), render());
      }
      break;
    }
    case "tec:usarnombretecnico": {
      const filaNt = state.tecnico.find((f) => f.id === el.dataset.fila),
        cardNt = state.cards.find((c) => c.id === el.dataset.card);
      if (filaNt && cardNt) (patch(cardNt, { titulo: filaNt.curso }), render());
      break;
    }
    case "curso:bajaid": {
      const cardBaja = state.cards.find((c) => c.id === el.dataset.id);
      if (cardBaja)
        (logAct(cardBaja, "dio de baja"),
    ...
    case "view:rename": {
      const hallado2 = state.savedViews.find((arg) => arg.id === el.dataset.id);
      if (!hallado2) break;
      const txt4 = (prompt("Nuevo nombre para la vista", hallado2.name) || "").trim();
      if (!txt4) break;
      ((hallado2.name = txt4), saveViews(), render(), flash("✏️ Vista renombrada"));
      break;
    }
    case "app:print": {
      const elMeta = $("#printMeta");
      if (elMeta) elMeta.innerHTML = printMetaHTML();
      window.print();
      break;
    }
    case "carga:open":
            ...
            if (val21 === "nuevo:open") openNuevo();
              ...
              if (val21 === "mis:toggle")
                ...
                if (val21 === "misemana:open") openMiSemana();
                  ...
                  if (val21 === "app:print") {
                    const elMetaPal = $("#printMeta");
                    if (elMetaPal) elMetaPal.innerHTML = printMetaHTML();
                    window.print();
                  }
                  else {
...
function applyTecField(id, campo, value) {
  ...
  if (campo === "curso" && fila.cardId) {
    const cardVinc = state.cards.find((c) => c.id === fila.cardId);
...
(document.addEventListener("input", (ev) => {
  ...
  document.addEventListener("change", (ev) => {
    ...
    if (ev.target.dataset && ev.target.dataset.tecId) {
      ...
      else if (ev.target.type === "checkbox" && TEC_CHKS.includes(ev.target.dataset.tecField))
        tecFichaSync(ev.target.dataset.tecId);
      return;
    }
...
function asignarme(id) {
  if (!state.userId) {
    flash("Entrá con tu nombre del equipo para asignarte", true);
    return;
  }
  const tarjeta = state.cards.find((c) => c.id === id);
  if (!tarjeta) return;
  if (!tarjeta.responsable) tarjeta.responsable = state.userId;
  else {
    ((tarjeta.asignados = tarjeta.asignados || []),
      tarjeta.asignados.includes(state.userId) || tarjeta.asignados.push(state.userId));
  }
  (touch(), render(), flash("🙋 Te asignaste la tarjeta"));
}
...
function mostrarPantallaSinConexion(err) {
  ...
  ($("#view") || document.body).innerHTML =
    ...
    (ultima
      ...
      : "") +
    // Cuando el backend se cae por un rato largo (una cuota agotada, por
    // ejemplo) "reintentar" no alcanza: hace falta poder sacar los datos de acá
    // y poder seguir trabajando igual. Las dos salidas van en la misma
    // pantalla, que es donde la persona está parada cuando lo necesita.
    '<p style="margin-top:16px;display:flex;gap:8px;flex-wrap:wrap">' +
    '<button class="btn primary" data-action="reintentar:conexion">Reintentar</button>' +
    (ultima
      ? '<button class="btn" data-action="local:bajar">⬇ Bajar mi copia (JSON)</button>' +
        '<button class="btn" data-action="local:trabajar">✎ Trabajar sin conexión</button>'
      : "") +
    "</p>" +
    (ultima
      ? '<p style="font-size:12px;opacity:.75;margin-top:2px">"Trabajar sin conexión" abre el tablero con esa copia y guarda todo en esta computadora. El equipo no ve esos cambios hasta que el backend vuelva y los subas.</p>'
      : "") +
    '<p style="margin-top:14px;font-size:12px;opacity:.7">Detalle técnico: ' +
    esc(String((err && err.message) || err)) +
    "</p></div>";
  // La pantalla de ingreso se esconde: sin backend no hay clave que validar
  // (el hash vive en el documento que no se pudo leer), así que dejarla puesta
  // solo tapa los botones de "bajar mi copia" y "trabajar sin conexión" — y
  // quedarse afuera de la propia copia local es peor que una barrera que, sin
  // datos que mostrar, no protege nada.
  ($("#gate") && $("#gate").classList.add("hidden"),
    $("#filters") && ($("#filters").innerHTML = ""),
    (state.ready = false));
}
// Abre el tablero con la copia local y corta todo trato con el backend hasta
// que la persona decida subir. Es el mismo camino que "restaurar una copia",
// pero sin escribir nada afuera.
function entrarModoLocal(copia) {
  let doc;
  try {
    doc = JSON.parse(copia.doc);
  } catch (e) {
    flash("La copia local está dañada", true);
    return;
  }
  ((modoLocal = true),
  ...
  (Array.isArray(doc.team) && doc.team.length && ((TEAM.length = 0), doc.team.forEach((m) => TEAM.push(m))),
    doc.agenda && typeof doc.agenda === "object" && (state.agenda = doc.agenda),
    typeof doc.appPassHash === "string" && (state.appPassHash = doc.appPassHash));
  // Técnico y Edu Point solo están en las copias hechas desde esta versión en
  // adelante; en una copia vieja no vienen y las grillas quedan vacías, que es
  // preferible a mostrar la semilla del Excel como si fueran sus datos.
  try {
    if (copia.tecnico) state.tecnico = JSON.parse(copia.tecnico).tecnico || [];
    if (copia.edu) state.eduArchivo = JSON.parse(copia.edu).eduArchivo || [];
  } catch (e) {}
  (ensureFraseDay(),
    ensureTeam(),
    injectSectorStyles(),
...
// Sale del modo local: intenta escribir TODO lo que se hizo al backend. Si
// funciona, se recarga para volver al flujo normal; si no, se sigue como
// estaba y no se pierde nada.
async function subirTrabajoLocal() {
  flash("Subiendo…");
  try {
    (sacarFotosDeLasTarjetas(), await Store.save(docSnapshotFotos(), false, FOTOS_FILA));
    await Store.save(docSnapshotTecnico(), false, TEC_FILA);
    await Store.save(docSnapshotEduArchivo(), false, EDU_FILA);
    await Store.save(docSnapshot());
    ((modoLocal = false), flash("✅ Subido — vuelve el trabajo compartido"));
    setTimeout(() => location.reload(), 900);
  } catch (err) {
    flash("El backend sigue sin responder. Seguís trabajando local, no se perdió nada.", true);
  }
}
function showBanner() {
  ...
  if (modoLocal)
    val2 =
      '<div class="note warn">✎ <b>Trabajando sin conexión.</b> Todo se guarda en esta computadora; el equipo todavía no lo ve. ' +
      '<button class="btn btn-sm" data-action="local:subir" style="margin-left:6px">Subir al backend</button></div>';
...
function openHelp() {
  const faq = [
    ...
    ["Atajos de teclado", "Con el foco fuera de un campo de texto: N crea una tarjeta nueva, y del 1 al 5 salta directo a Inicio, Planner, Calendario, Timeline o Mapa."],
    ...
    ["🔧 Seguimiento técnico", "Reemplaza al Excel de Categorías y Cursos. El encabezado va en dos pisos: arriba el bloque (Fechas, Piezas, Formato, Seguimiento) y abajo cada columna. Publicación, subida del SCORM, mail, portada, mosaico, evaluación, textos y diseño de cada curso, editable ahí mismo. Con <b>▦ Columnas</b> elegís cuáles ver (queda guardado en tu computadora, no le cambia la vista al resto). \"🔗 Vincular\" une una fila con su tarjeta del Mapa. Debajo de los cursos de cada categoría cuelgan sus <b>Archivos Edu Point</b>, con el mismo tratamiento."],
    ["📈 Reportes", "El bloque grande de arriba es cuánto se publicó en el año que elijas, con su gráfico por mes y la línea punteada del promedio para leer cada mes contra lo normal del año; al costado, tres números para mirar de reojo, cada uno con su lista a un clic. Abajo, el histórico por año y el catálogo por sector como una sola barra de colores (clic en cualquier sector de la referencia para ver sus cursos). \"⬇ CSV\" y \"🖨 PDF\" exportan lo mismo que se ve en pantalla, para el año que estés mirando."],
  ];
  openModal(
...
function delSector(key) {
  ...
  confirmar('¿Borrar el sector "' + nombre + '"? Las tarjetas que lo tenían van a perder esa etiqueta.', () => {
    (delete SECTORES[key], persist(), openSettings(), render(), flash("🗑 Sector borrado"));
  });
}
function delMember(id) {
  ...
  confirmar('¿Sacar a "' + miembro.nombre + '" del equipo? Sus tarjetas asignadas van a quedar sin esa persona.', () => {
    const idx = TEAM.findIndex((arg) => arg.id === id);
    if (idx >= 0) TEAM.splice(idx, 1);
    (persist(), openSettings(), render(), flash("🗑 Se sacó del equipo"));
  });
}
    ...
    JSON.stringify(
      {
        ...
        sectores: SECTORES,
        team: TEAM,
        // Lo que vive en filas separadas del backend (portadas, Seguimiento
        // técnico y Archivos Edu Point) va aparte, para que el archivo
        // exportado se baste solo y sirva para mudar todo de proyecto.
        fotos: state.fotos,
        tecnico: state.tecnico,
        eduArchivo: state.eduArchivo,
      },
...
async function arrancarApp() {
  ...
  // Seguimiento técnico vive en su propia fila (TEC_FILA) — no se pisa con
  // el try/catch de arriba: si esto falla, el tablero igual arranca bien y
  // más abajo se completa con la semilla del Excel.
  try {
    const tecDoc = await Store.load(TEC_FILA);
    if (tecDoc && Array.isArray(tecDoc.tecnico)) state.tecnico = tecDoc.tecnico;
    if (tecDoc && tecDoc.deletedTecnico && typeof tecDoc.deletedTecnico === "object")
      state.deletedTecnico = pruneTombstones(tecDoc.deletedTecnico);
  } catch (errTec) {
  ...
  (state.cards.forEach((tarjeta2) => {
    ...
    // Semilla del Excel de Categorías y Cursos: se carga una sola vez, la
...
async function hayNovedades() {
  ...
  if (!rev) return true;
  // El sello NO se anota acá. Lo anota quien baja el documento de verdad: si
  // se anotara antes, la mezcla que viene justo después vería "ya lo tengo" y
  // no bajaría nada — el cambio del otro nunca llegaría. Y si la bajada
  // fallara, en la próxima vuelta se vuelve a intentar en vez de darla por
  // vista.
  return rev !== revConocida;
}
